...
<%
    ...
    if (!completeURL.contains("null")){
        ...
        if (!bdController.existePalabra(palabra) && !bdController.existePalabraEsp(palabra)) {
            error = "No existe esa palabra en nuestro vocabulario";
            display = "block";
        }else {
            bdController.bajaPalabra(palabra);
            response.sendRedirect("carteraVoc.jsp");
        }
    }
%>
<div class="wrapper">
    ...
    <div style="width: 100%;"  id="content">
        ...
        <form>
            <div class="form-group row">
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="palabra" id="inputPalabra" placeholder="Escriba la palabra" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
